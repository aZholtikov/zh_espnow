...
esp_err_t zh_espnow_init(zh_espnow_init_config_t *config)
{
    ...
    xTaskCreate(&s_zh_espnow_processing, "zh_espnow_processing", s_zh_espnow_init_config.stack_size, NULL, s_zh_espnow_init_config.task_priority, &s_zh_espnow_processing_task);
    return ESP_OK;
}
